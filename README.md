...
O **MesclaInvest** é uma plataforma mobile desenvolvida para conectar a comunidade ao ecossistema de startups do **Mescla** (Hub de Inovação da PUC-Campinas). O aplicativo permite que usuários atuem como **Investidores Anjo**, gerenciando ativos digitais (tokens) e apoiando o crescimento de novos negócios em um ambiente seguro e educacional.
...
Este aplicativo foi desenvolvido para fins estritamente acadêmicos (Projeto Integrador 3 - Engenharia de Software). 
